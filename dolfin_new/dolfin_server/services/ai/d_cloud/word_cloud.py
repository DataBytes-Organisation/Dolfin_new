...
def generate(data_with_level, level='level 0', mode='default', preprocess=True):
    """
    ...
    def convert_wordcloud_into_base64(wordcloud_object):
        """
        Converts a WordCloud object into a base64-encoded image.
    ...
    return convert_wordcloud_into_base64(wordcloud)
